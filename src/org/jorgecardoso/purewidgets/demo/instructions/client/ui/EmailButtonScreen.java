...
public class EmailButtonScreen extends Composite  {

	private static MainScreenUiBinder uiBinder = GWT.create(MainScreenUiBinder.class);

	interface MainScreenUiBinder extends UiBinder<Widget, EmailButtonScreen> {
	}
	...
	public EmailButtonScreen(Place place) {
		initWidget(uiBinder.createAndBindUi(this));
		
		// Using a TextResource
		uiInlineHTML.setHTML( Resources.INSTANCE.emailButtonSvg().getText());
		...
		if ( null != e) {
			e.setInnerText(msgs.buttonLabel());
		}
		...
		if ( null != e) {
			e.setInnerText(msgs.emailButtonSubject());
		}			
